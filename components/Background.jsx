...
`;
    ...
    const onPointerMove = e => {
      ...
      const x = Math.max(0, Math.min(containerWidth, (e.clientX - rect.left) * scale));
      const y = Math.max(0, Math.min(containerHeight, containerHeight - (e.clientY - rect.top) * scale));
